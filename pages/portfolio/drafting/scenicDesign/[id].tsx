...
import { scenicDesignContentAtom, theatreContentAtom } from "@/state/content";
...
const neighborPagesImagesAtom = atomWithStorage('portfolio-drafting_scenicDesign-neighbors', [])
...
export const ProgrammingDocPage = ({
    ...
    //@ts-ignore
    useHydrateAtoms([
        [scenicDesignContentAtom, contentData]
    ])
    const [content] = useAtom(scenicDesignContentAtom);
