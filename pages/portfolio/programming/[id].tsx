...
import { programmingContentAtom, theatreContentAtom } from "@/state/content";
...
const neighborPagesImagesAtom = atomWithStorage('portfolio-programming-neighbors', [])
...
export const ProgrammingDocPage = ({
    ...
    //@ts-ignore
    useHydrateAtoms([
        [programmingContentAtom, contentData]
    ])
    const [content] = useAtom(programmingContentAtom);
                    ...
                    <section className="mt-48 overflow-x-auto">
                        ...
                        <DynamicWrapper>
                            <NextPrevDynamicPageButtons
                                pageSlug="/portfolio/programming"
...
export async function getServerSideProps(context) {
    ...
    const contentData = await getContentBySchemaName("programming");
